---
title: Captcha
description: Verify captcha tokens before protected endpoints.
---
...
{/* Upstream guide is preserved in reference/upstream-src/1.6.9/repository/docs/content/docs/plugins/captcha.mdx. */}