...
require "better_auth/stripe" # [!code highlight]

auth = BetterAuth.auth(
  plugins: [
    BetterAuth::Plugins.stripe( # [!code highlight]
      stripe_api_key: ENV.fetch("STRIPE_SECRET_KEY"), # [!code highlight]
      stripe_webhook_secret: ENV.fetch("STRIPE_WEBHOOK_SECRET"), # [!code highlight]
      create_customer_on_sign_up: true, # [!code highlight]
      subscription: { # [!code highlight]
        enabled: true, # [!code highlight]
        plans: [ # [!code highlight]
          { # [!code highlight]
            name: "pro", # [!code highlight]
            price_id: "price_1234567890" # [!code highlight]
          } # [!code highlight]
        ] # [!code highlight]
      } # [!code highlight]
    ) # [!code highlight]
...
A lot of fixes and refinements to make everything smoother, faster, and more reliable. Check out the [changelog](https://github.com/sebasxsala/better-auth-rb/releases/tag/v1.2.0) for more details.

---

```ruby title="Gemfile"
gem "better_auth", "1.2.0"
```
