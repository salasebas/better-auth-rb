...
Gem::Specification.new do |spec|
  spec.name = "openauth-scim"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-scim"
  spec.description = "OpenAuth SCIM alias package that installs better_auth-scim."
  ...
  spec.add_dependency "better_auth-scim", "0.10.0"
end
