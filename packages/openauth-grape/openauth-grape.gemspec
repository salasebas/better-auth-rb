...
Gem::Specification.new do |spec|
  spec.name = "openauth-grape"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-grape"
  spec.description = "OpenAuth Grape alias package that installs better_auth-grape."
  ...
  spec.add_dependency "better_auth-grape", "0.10.0"
end
