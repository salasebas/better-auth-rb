...
Gem::Specification.new do |spec|
  spec.name = "openauth-roda"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-roda"
  spec.description = "OpenAuth Roda alias package that installs better_auth-roda."
  ...
  spec.add_dependency "better_auth-roda", "0.10.0"
end
