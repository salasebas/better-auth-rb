...
Gem::Specification.new do |spec|
  spec.name = "openauth-sinatra"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-sinatra"
  spec.description = "OpenAuth Sinatra alias package that installs better_auth-sinatra."
  ...
  spec.add_dependency "better_auth-sinatra", "0.10.0"
end
