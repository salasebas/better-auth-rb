...
require_relative "lib/better_auth/telemetry/version"

Gem::Specification.new do |spec|
  spec.name = "better_auth-telemetry"
  spec.version = BetterAuth::Telemetry::VERSION
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Optional telemetry package for Better Auth Ruby"
  spec.description = [
    "Adds opt-in init telemetry for Better Auth Ruby, mirroring the upstream @better-auth/telemetry wire format.",
  ...
  spec.metadata["changelog_uri"] = "https://github.com/sebasxsala/better-auth-rb/blob/main/packages/better_auth-telemetry/CHANGELOG.md"
