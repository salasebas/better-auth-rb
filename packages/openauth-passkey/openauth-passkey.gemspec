...
Gem::Specification.new do |spec|
  spec.name = "openauth-passkey"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-passkey"
  spec.description = "OpenAuth passkey alias package that installs better_auth-passkey."
  ...
  spec.add_dependency "better_auth-passkey", "0.10.0"
end
