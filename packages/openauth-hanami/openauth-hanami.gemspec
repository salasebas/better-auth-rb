...
Gem::Specification.new do |spec|
  spec.name = "openauth-hanami"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-hanami"
  spec.description = "OpenAuth Hanami alias package that installs better_auth-hanami."
  ...
  spec.add_dependency "better_auth-hanami", "0.10.0"
end
