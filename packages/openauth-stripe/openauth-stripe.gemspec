...
Gem::Specification.new do |spec|
  spec.name = "openauth-stripe"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-stripe"
  spec.description = "OpenAuth Stripe alias package that installs better_auth-stripe."
  ...
  spec.add_dependency "better_auth-stripe", "0.10.0"
end
