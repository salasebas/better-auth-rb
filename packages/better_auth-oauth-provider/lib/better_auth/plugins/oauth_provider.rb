...
module BetterAuth
  module Plugins
    ...
    def oauth_provider_endpoints(config)
      {
        get_oauth_server_config: oauth_server_metadata_endpoint(config),
        get_openid_config: oauth_openid_metadata_endpoint(config),
        register_oauth_client: oauth_register_client_endpoint(config),
        create_oauth_client: oauth_create_client_endpoint(config),
        admin_create_oauth_client: oauth_admin_create_client_endpoint(config),
        admin_update_oauth_client: oauth_admin_update_client_endpoint(config),
        get_oauth_client: oauth_get_client_endpoint(config),
        get_oauth_client_public: oauth_get_client_public_endpoint(config),
        get_oauth_client_public_prelogin: oauth_get_client_public_prelogin_endpoint(config),
        get_oauth_clients: oauth_list_clients_endpoint(config),
        delete_oauth_client: oauth_delete_client_endpoint(config),
        update_oauth_client: oauth_update_client_endpoint(config),
        rotate_oauth_client_secret: oauth_rotate_client_secret_endpoint(config),
        get_oauth_consents: oauth_list_consents_endpoint,
        get_oauth_consent: oauth_get_consent_endpoint,
        update_oauth_consent: oauth_update_consent_endpoint,
        delete_oauth_consent: oauth_delete_consent_endpoint,
        oauth2_authorize: oauth_authorize_endpoint(config),
        oauth2_continue: oauth_continue_endpoint(config),
        oauth2_consent: oauth_consent_endpoint(config),
        oauth2_token: oauth_token_endpoint(config),
