...
Gem::Specification.new do |spec|
  spec.name = "openauth-telemetry"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-telemetry"
  spec.description = "OpenAuth Telemetry alias package that installs better_auth-telemetry."
  ...
  spec.add_dependency "better_auth-telemetry", "0.10.0"
end
