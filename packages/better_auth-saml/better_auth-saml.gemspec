...
require_relative "lib/better_auth/saml/version"

Gem::Specification.new do |spec|
  spec.name = "better_auth-saml"
  spec.version = BetterAuth::SAML::VERSION
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "SAML 2.0 SP support for Better Auth Ruby SSO"
  spec.description = [
    "SAML 2.0 service provider primitives and plugin extensions for Better Auth Ruby enterprise SSO.",
    "Pair with better_auth-sso for provider management or require directly for SAML-only integrations."
  ].join(" ")
  ...
  spec.metadata["changelog_uri"] = "https://github.com/sebasxsala/better-auth-rb/blob/main/packages/better_auth-saml/CHANGELOG.md"
