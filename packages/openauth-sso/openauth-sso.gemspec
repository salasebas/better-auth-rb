...
Gem::Specification.new do |spec|
  spec.name = "openauth-sso"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-sso"
  spec.description = "OpenAuth SSO alias package that installs better_auth-sso."
  ...
  spec.add_dependency "better_auth-sso", "0.10.0"
end
