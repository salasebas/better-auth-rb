...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Alias package for better_auth-oauth-provider"
  spec.description = "OpenAuth OAuth provider alias package that installs better_auth-oauth-provider."
  ...
  spec.add_dependency "better_auth-oauth-provider", "0.10.0"
end
