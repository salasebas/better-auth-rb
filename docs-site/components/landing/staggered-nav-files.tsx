...
const GITHUB_REPO_URL = "https://github.com/salasebas/better-auth-rb";
const RUBYGEMS_GEM_URL = "https://rubygems.org/gems/better_auth";

const RubyGemsIcon: React.FC<{ className?: string }> = ({ className }) => (
	<svg
		...
		aria-hidden="true"
	>
		<polygon fill="#e9573f" points="32 4 58 22 58 46 32 60 6 46 6 22" />
		<polygon
			fill="#ffffff"
			fillOpacity="0.22"
...
const logoAssets = {
	darkSvg: logoMarkSvg.dark,
	whiteSvg: logoMarkSvg.light,
	darkWordmark: logoWordmarkSvg.dark,
	whiteWordmark: logoWordmarkSvg.light,
};
						...
						<AnimatePresence>
							{resourcesOpen && (
								...
								>
									...
									<div className="border-t border-foreground/[0.06]">
										{linkResources.map((r) => (
											<Link
												...
												href={r.href}
												onClick={() => setResourcesOpen(false)}
												className="group/p relative flex items-center gap-2 px-4 py-3 hover:bg-foreground/[0.03] transition-colors"
											>
									...
									<div className="flex items-center justify-center gap-6 border-t border-foreground/[0.06] px-4 py-2.5">
										<a
