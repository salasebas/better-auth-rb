...
export function BlogLeftPanel({ postCount, post }: BlogLeftPanelProps) {
	if (post) {
		return (
			<div className="relative w-full lg:w-[30%] lg:h-dvh lg:sticky lg:top-0 border-b lg:border-b-0 lg:border-r border-foreground/[0.06] bg-background overflow-hidden px-5 sm:px-6 lg:px-10">
				...
				<div className="space-y-4">
					<div className="space-y-1">
						...
						<p className="text-sm text-foreground/70 dark:text-foreground/50 leading-relaxed max-w-[240px] pt-1">
							Updates from the Better Auth Ruby port.
						</p>
					</div>
