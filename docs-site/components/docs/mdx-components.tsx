...
interface Field extends SchemaField {}
		...
		<div className="my-4 border shadow-sm overflow-hidden dark:bg-[#030303]">
			...
			{view === "table" ? (
				...
				<SchemaCodeBlock
					code={
						view === "sql"
							? generateCreateTableSql(tableName, fields, sqlDialect)
							: generateRubySchemaSnippet(tableName, fields)
					}
					lang={view === "sql" ? "sql" : "ruby"}
				/>
			)}
		</div>
	);
...
export { RubyAuthDisclaimer } from "./disclaimer";
