...
To use the MongoDB adapter, you need to install the `better_auth-mongodb` gem:
...
The Ruby MongoDB adapter supports joins.
...
{/* Upstream MongoDB guide is preserved in reference/upstream-src/1.6.23/repository/docs/content/docs/adapters/mongo.mdx. */}
