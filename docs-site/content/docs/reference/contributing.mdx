...
Thank you for your interest in contributing to RubyAuth! This guide is a concise guide to contributing to RubyAuth.
...
<Steps>
  ...
  <Step>
    ...
    Make sure you have Ruby, Bundler, and the workspace gems installed.
...
Thank you for contributing to RubyAuth!
