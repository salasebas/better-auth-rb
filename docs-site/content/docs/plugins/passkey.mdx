...
| --- | --- | --- |
| `POST` | `/passkey/generate-register-options` | `auth.api.generate_passkey_registration_options` |
| `POST` | `/passkey/generate-authenticate-options` | `auth.api.generate_passkey_authentication_options` |
...
{/* Upstream guide is preserved in reference/upstream-src/1.6.9/repository/docs/content/docs/plugins/passkey.mdx. */}
