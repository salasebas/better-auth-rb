...
auth = BetterAuth.auth(
  ...
  plugins: [
    BetterAuth::Plugins.generic_oauth(providers: [{ provider_id: "custom", client_id: ENV.fetch("OAUTH_CLIENT_ID"), client_secret: ENV.fetch("OAUTH_CLIENT_SECRET"), discovery_url: "https://provider.example/.well-known/openid-configuration" }])
  ]
)
```
  </Step>
