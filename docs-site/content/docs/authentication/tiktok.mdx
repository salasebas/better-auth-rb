---
title: TikTok
description: TikTok provider setup and usage in Better Auth Ruby.
---
...
<Steps>
  ...
  <Step>
    ...
    auth = BetterAuth.auth(
      ...
      social_providers: {
        tiktok: BetterAuth::SocialProviders.tiktok(
          client_id: ENV.fetch("TIKTOK_CLIENT_ID"),
  ...
  <Step>
    ...
    To sign in with TikTok, call `auth.api.sign_in_social` on your Ruby auth instance. The endpoint body takes the following properties:
